...
class PromptRepository(PromptRepositoryInterface):
    ...
    def __init__(self):
        ...
        self._logger.info(
            "Initializing PromptRepository", component="prompt_repository"
        )
    ...
    async def describe_pr_user_prompt(self, request: PromptRequest) -> str:
        ...
        self._logger.info(
            "Generated PR description user prompt", component="prompt_repository"
        )
        return prompt
...
{request.get_context_string()}
  ...
  <requirements>
    ...
    async def describe_pr_system_prompt(self) -> str:
        ...
        self._logger.info(
            "Generated PR description system prompt", component="prompt_repository"
        )
        return prompt
    ...
    async def review_pr_system_prompt(self) -> str:
        ...
        self._logger.info(
            "Generated PR review system prompt", component="prompt_repository"
        )
        return prompt
    ...
    async def update_changelog_system_prompt(self) -> str:
        ...
        self._logger.info(
            "Generated changelog system prompt", component="prompt_repository"
        )
        return prompt
...
{request.get_context_string()}
  ...
  <output_requirements>
    ...
    async def approve_pr_system_prompt(self) -> str:
        ...
        self._logger.info(
            "Generated PR approval system prompt", component="prompt_repository"
        )
        return prompt
