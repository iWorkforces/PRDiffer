...
## OVERVIEW
- **141** Python files under `tests/` (~37K lines)
- **~2495** `test_*` functions across **125** `test_*.py` files
...
├── unit/
│   ├── domain/                      # Entities, use cases, errors, registry, cache v2/v1, GitLabConfig
