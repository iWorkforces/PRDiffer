...
- [x] 13. Route GitLab through the generic strict session cache path and invalidate legacy cache behavior
...
- [x] 14. Compose the GitLab strict reader through settings, factory, and server wiring
