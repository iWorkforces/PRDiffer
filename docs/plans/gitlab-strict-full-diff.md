...
- [ ] 5. Build the bounded GitLab SDK execution runtime and status-aware exception mapper
...
- [ ] 9. Admit a complete ordered GitLab inventory and classify every file state
...
- [ ] 10. Fetch typed old/new file content at immutable refs
...
- [ ] 11. Assemble ordered GitLab full-context file responses with strict size and state guarantees
...
- [ ] 12. Implement the request-scoped GitLab strict diff session
