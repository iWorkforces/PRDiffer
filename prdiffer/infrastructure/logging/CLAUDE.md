...
This file provides guidance for working with the logging infrastructure of PRDiffer.
...
def test_component_logging():
    with patch('prdiffer.infrastructure.logging.console_logger.get_logger') as mock_logger:
