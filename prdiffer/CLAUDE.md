# CLAUDE.md - PRDiffer Main Package

This file provides guidance for working with the main PRDiffer package structure.
...
Example usage:
```python
from prdiffer.infrastructure import (
...
- **Python 3.14.2+**: Required Python version
