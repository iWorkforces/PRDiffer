...
## OVERVIEW
Core business models, service interfaces, data contracts, and VCS provider registry. Pure business logic layer with no external dependencies, frameworks, or I/O operations.
